// ref-webui — a tool with a Web UI card (generated by create-dsh-plugin).
//
...
export function apply(ctx: Context) {
  ...
  console.log(
    `[ref-webui] registered "ref_webui" (webui diff card) — listed=${ctx.tools.get('ref_webui') !== undefined}`,
  )
}
