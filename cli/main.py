...
def print_banner():
    banner = f"""
{COLORS['cyan']}╔══════════════════════════════════════════════════════╗
║        {COLORS['bold']}ClawMemory v5.0.9 - AI Agent 终身记忆系统{COLORS['reset']}{COLORS['cyan']}        ║
║      四层记忆架构 · 知识图谱 · 多模态 · 人格化      ║
╚══════════════════════════════════════════════════════╝{COLORS['reset']}
"""
    print(banner)
...
<head>
    ...
    <title>ClawMemory 导出 - {count} 条记忆</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🧠 ClawMemory 记忆导出</h1>
            <p>共 {count} 条记忆 · 导出时间：{export_time}</p>
        </div>
        {cards}
        <div class="footer">
            <p>Generated by ClawMemory v5.0.9</p>
        </div>
    </div>
</body>
</html>"""
...
def main():
    parser = argparse.ArgumentParser(
        prog="clawmemory",
        description="ClawMemory v5.0.9 - AI Agent 终身记忆系统",
